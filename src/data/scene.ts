...
const pageBlueprints: PageBlueprint[] = [
  {
    ...
    keywords: ['couverture', 'frontispice', 'ouverture', 'manifeste'],
    kind: 'image',
    pageNumber: '01',
    ...pageSources('01'),
  },
  {
    ...
    keywords: ['prevalence', 'statistique', 'incidence', 'pourcentage'],
    kind: 'image',
    pageNumber: '02',
    ...pageSources('02'),
  },
  {
    ...
    keywords: ['sommaire', 'index', 'table', 'plan'],
    kind: 'image',
    pageNumber: '03',
    ...pageSources('03'),
  },
  {
    ...
    keywords: ['cecite', 'analogique', 'pendule', 'delai'],
    kind: 'image',
    pageNumber: '04',
    ...pageSources('04'),
  },
  {
    ...
    keywords: ['clochers', 'pomodoro', 'metronome', 'sonnerie'],
    kind: 'image',
    pageNumber: '05',
    ...pageSources('05'),
  },
  {
    ...
    keywords: ['minuteur', 'timer', 'compteur', 'duree'],
    kind: 'image',
    pageNumber: '06',
    ...pageSources('06'),
  },
  {
    ...
    keywords: ['horloge', 'quai', 'led', 'rush'],
    kind: 'image',
    pageNumber: '07',
    ...pageSources('07'),
  },
  {
    ...
    keywords: ['regard', 'oculaire', 'balayage', 'oculometrie'],
    kind: 'image',
    pageNumber: '08',
    ...pageSources('08'),
  },
  {
    ...
    keywords: ['propagande', 'normatif', 'agenda', 'discipline'],
    kind: 'image',
    pageNumber: '09',
    ...pageSources('09'),
  },
  {
    ...
    keywords: ['patrons', 'tactilite', 'wabisabi', 'zonage'],
    kind: 'image',
    pageNumber: '10',
    ...pageSources('10'),
  },
  {
    ...
    keywords: ['energie', 'facilite', 'effort', 'simplicite'],
    kind: 'image',
    pageNumber: '11',
    ...pageSources('11'),
  },
  {
    ...
    keywords: ['empilage', 'etapes', 'superposition', 'parcours'],
    kind: 'image',
    pageNumber: '12',
    ...pageSources('12'),
  },
  ...
  },
  {
    ...
    keywords: ['outils', 'catalogue', 'interface', 'trousse'],
    kind: 'image',
    pageNumber: '14',
    ...pageSources('14'),
  },
  {
    ...
    keywords: ['bidouille', 'prothese', 'ajustement', 'bricolage'],
    kind: 'image',
    pageNumber: '15',
    ...pageSources('15'),
  },
  {
    ...
    keywords: ['rhomboide', 'objectif', 'sousbuts', 'parasites'],
    kind: 'image',
    pageNumber: '16',
    ...pageSources('16'),
  },
  {
    ...
    keywords: ['resonance', 'bruit', 'pulsation', 'calage'],
    kind: 'image',
    pageNumber: '17',
    ...pageSources('17'),
  },
  {
    ...
    keywords: ['geospatiale', 'itineraire', 'repere', 'cartographie'],
    kind: 'image',
    pageNumber: '18',
    ...pageSources('18'),
  },
